...
drivers <- dat %>%
  ...
  slice(-1)
{(\frac{E}{k_b} \times (\frac{1}{293} - \frac{1}{T_t}))}$$$$B_t = (B_{t-1} + r + \lambda e^{B_{t-1}}) \times (1 - \beta Q_t) + \epsilon_t$$$$\epsilon_t \sim N(0,\sigma_{proc})$$$$P_{obs,t} \sim N(P_t, \sigma_{obs})$$
