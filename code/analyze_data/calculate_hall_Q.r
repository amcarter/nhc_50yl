...
library(tidyverse)
stage <- read_csv("data/hall/hall_figure26_digitized_dailystage.csv") 
...
write_csv(hall_Q, "data/hall/hall_figure26_digitized_dailystage.csv")
# calculate stage at 1 cms discharge:
hall_1cms_stage <- exp((log(1) - a)/b)/100

# pair with temperature:
temp <- read_csv('data/hall/hall_figure27_digitized_mean_daily_temp.csv')
...
write_csv(hall, "data/hall/hall_discharge_temp_daily.csv")
